...
def load_dataset(train_data_path, dev_data_path, test_data_path, txt_wordVectors_path,\
    ...
    #Process text data
    #sequential: datatype represents sequential data
    #tokenize: functions to tokenize string
    #pad_token: token string used as padding
    #lower: conver to lowercase
    #include_lengths: return tuple of length of examples (padded minibatch)
    #batch _first: produce domension with batch first
    ...
    #Turn processed data into tabular dataset
    ...
    # vector is pretrianed word embedding vector file (standard is one used)
    ...
    print(txt_vocab_size)
    cpt_vocab_size = len(cpt_TEXT.vocab)
    print(cpt_vocab_size)
