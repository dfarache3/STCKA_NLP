...
class STCK_Atten_leakyrelu(nn.Module):
    def __init__(self, text_vocab_size, concept_vocab_size, embedding_dim, txt_embedding_weights,\
        ...
        super(STCK_Atten_leakyrelu, self).__init__()
    ...
    def cst_attention(self, c, q):
        ...
        c_q = self.w1(F.leaky_relu(self.W1(c_q))) # batch_size, concept_seq_len, 1
    ...
    def ccs_attention(self, c):
        # c: batch_size, concept_seq_len, embedding_dim
        c = self.w2(F.leaky_relu(self.W2(c))) # batch_size, concept_seq_len, 1
